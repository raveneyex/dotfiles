...
# Generated by Powerlevel10k configuration wizard on 2024-01-28 at 18:27 -05.
...
# 12h time, 1 line, compact, concise, instant_prompt=off.
...
() {
  ...
  typeset -g POWERLEVEL9K_BACKGROUND=${DEFAULT_BACKGROUND}
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND="%F{$DEFAULT_FOREGROUND}\uf179%f"
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=001
  ...
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_ICON_COLOR=red

  # These settings are used for repositories other than Git or when gitstatusd fails and
  # Powerlevel10k has to fall back to using vcs_info.
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=$DEFAULT_FOREGROUND
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=$DEFAULT_FOREGROUND
  typeset -g POWERLEVEL9K_VCS_MODIFIED_FOREGROUND=$GIT_MODIFIED_COLOR
  ...
  # Nvm color.
  typeset -g POWERLEVEL9K_NVM_FOREGROUND=001
  ...
  typeset -g POWERLEVEL9K_BATTERY_DISCONNECTED_FOREGROUND=118
  ...
  function prompt_spotify() {
    local state=`osascript -e 'tell application "Spotify" to player state as string'`;
    if [ $state = "playing" ]; then
      ...
      local prompt="$artist - $track";
    fi
    p10k segment -s $state -i '' -t ${prompt} -f 028
  }

  function instant_prompt_spotify() {
    p10k segment -i '' -t 'Loading player data...' -f 028
  }

  ####################################[ USER TOKEN]################################################
  function prompt_user_char() {
    p10k segment -i '߭' -f 196
  }

  function instant_prompt_user_char() {
    prompt_user_char
  }
